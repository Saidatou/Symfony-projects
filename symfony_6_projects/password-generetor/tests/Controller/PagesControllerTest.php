...
class PagesControllerTest extends WebTestCase
{
    ...
    {
        //methode pour enlever le cash : $client->restart();
        // la methode relaod pour recharger une page, la methode back pour aller à la page précédente
        //la methode forward pour aller à la page suivante
    ...
    /** @test */
    public function cookies_are_set_when_genarating_new_password(): void
    {
